...
| P7-07 release package (parent) | immutable digests, changelog, operations docs, evidence archive, residual-risk register, `REPORT.md` per development plan §27A | V-P7-01, V-P7-16, V-P7-17, V-P7-18 |
...
runtime dependency may be added. Every scan finding that is not Low needs an owner and a deadline.
